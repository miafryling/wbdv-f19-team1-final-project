            ...
            <div>
                <div className="card-header">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" id="animalSize" value={this.state.selectedSize} onChange={this.onSizeChange}>
                        <option value=""></option>
                      ...
                      <select class="form-control" id="animalGender" value={this.state.selectedGender} onChange={this.onGenderChange}>
                        <option value=""></option>
                        <option value="male">Male</option>
                        <option value="female">Female</option>
                      </select>
                      <select class="form-control" id="animalAge" value={this.state.selectedAge} onChange={this.onAgeChange}>
                        <option value=""></option>
                      ...
                      <select class="form-control" id="animalColor" value={this.state.selectedColor} onChange={this.onColorChange}>
                        <option value=""></option>
                        {
                          this.state.colors[this.state.selectedType] ?
                          this.state.colors[this.state.selectedType].map(x => <option value={x}>{x.charAt(0).toUpperCase() + x.substring(1)}</option>) :
                          <div></div>
                        }
                      </select>
                      <select class="form-control" id="animalCoat" value={this.state.selectedCoat} onChange={this.onCoatChange}>
                        <option value=""></option>
                      ...
                      <select class="form-control" id="animalStatus" value={this.state.selectedStatus} onChange={this.onStatusChange}>
                        <option value=""></option>
